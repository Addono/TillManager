<div class="ui-body ui-body-a ui-corner-all">
    <h3><?php echo _("Get out, admin only here!"); ?></h3>
    <p><?php echo _("You need to be logged  in as an administrator to be allowed to access this page. Click the 'Home' button to go back to safety."); ?><br></p>
