<div class="ui-body ui-body-a ui-corner-all">
    <h3><? echo _("Get out, till manager here!"); ?></h3>
    <p><? echo _("You need to be logged  in as a till manager to be allowed to access this page. Click the 'Home' button to go back to safety."); ?><br></p>
